...
export function Nav() {
  return (
    <header
      ...
      className="bg-gray-900 sticky top-0 mt-2 text-md"
    >
          ...
          <div className="flex items-center gap-4">
            <form>
              <div className="relative">
                <input
                  className="h-10 p-2 lg:w-96 sm:w-52 w-32 rounded-lg border-gray-200 placeholder-gray-300 focus:z-10"
                  placeholder="Search..."
                  type="text"
                />
            ...
            <div className="sm:flex hidden sm:gap-4">
              <Link
                to="/login"
                className="block rounded-md cursor-pointer bg-teal-600 px-5 py-2  font-medium text-white transition hover:bg-teal-700 dark:hover:bg-teal-500"
              >
                Login
              </Link>
            </div>
